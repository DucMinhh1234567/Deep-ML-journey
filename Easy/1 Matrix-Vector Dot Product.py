...
# can be dotted with a vector (a list) only if the number of columns in the matrix equals 
# the length of the vector. For example, an n x m matrix requires a vector of length m.
